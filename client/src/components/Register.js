...
class Register extends Component {
  constructor(props) {
    ...
    this.onChangeHealthcareInstitution = this.onChangeHealthcareInstitution.bind(
      this
    );
  ...
  regPatient = async () => {
    ...
    console.log(
      "*** isPatient",
      await contract.methods.isPatient(accounts[0]).call()
    );
    console.log(
      "*** Exsisting",
      await contract.methods.isExistingPatient(0).call()
    );
    console.log(
      "######## Event",
      response.events.registeredPatient.returnValues[0]
    );
    // const patient1 = await contract.methods.getPatientAddress(0).call();
    // console.log("$$$$$$$Patient 1:", patient1);
    this.setState({
      bcAddress: response.events.registeredPatient.returnValues[0],
    });
    return response;
  };
              ...
              <div>
                ...
                {this.state.roleId === "3" && (
                  <div>
                    ...
                    <div className="form-group">
                      <label htmlFor="healthcareInstitution">
